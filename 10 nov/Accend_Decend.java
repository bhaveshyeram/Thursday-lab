/*
Write a program to accept size from user accordingly accept no from the user and find out the greater no, smaller no, display no in ascending and descending order
(Using function and array).
*/
import java.util.Scanner;

public class Accend_decend {
	...
	public static void main(String[] args) 
	{
		...
		Accend_decend obj=new Accend_decend ();
		obj.accept();
	}
	public void accept()
	{
		System.out.println("Enter tyhe size");
		size=sc.nextInt();
